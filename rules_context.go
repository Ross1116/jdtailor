...
func defaultPromptRules() []PromptRule {
	return []PromptRule{
		...
		{RuleKey: "resume.human_style", Category: "resume", Title: "Human technical style", Content: "Write plain, specific resume bullets that sound like a technical person wrote them. Use active voice, concrete artifacts, real tools, and varied sentence rhythm. Cut filler, stock transitions, fake excitement, generic business impact, and assistant-style wording.", Source: "plans/JOB_COPILOT_FULL_PLAN.md + user humanization research"},
		{RuleKey: "resume.banned_phrases", Category: "resume", Title: "Banned resume phrasing", Content: "Avoid inflated resume cliches: leveraged, spearheaded, empowered, utilized, cutting-edge, innovative, robust when vague, seamless, dynamic, pivotal, deep dive, in-depth, game-changer, unlock, drive growth, enhance efficiency, and generic endings like to improve business outcomes unless evidence proves them.", Source: "user humanization research"},
		{RuleKey: "resume.plain_bullets", Category: "resume", Title: "Plain bullet shape", Content: "Keep bullets direct and factual. One bullet should express one main claim. Prefer short concrete wording over abstract phrasing. Do not use markdown, hashtags, rhetorical questions, hype, or repeated sentence structures.", Source: "user humanization research"},
